...
class User(Base):
    ...
    Type: Mapped[UserEnum] = mapped_column(
        SQLEnum(UserEnum), nullable=True, default=UserEnum.Student
    )

    is_learned: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
